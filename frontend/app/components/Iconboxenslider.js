...
export default function IconBoxSlider() {
    ...
    const NextArrow = ({ onClick }) => {
        return (
            <div
                className="absolute top-1/2 right-0 transform -translate-y-1/2 bg-dunkel text-white w-10 h-10 flex items-center justify-center rounded-full cursor-pointer z-10 opacity-30 hover:opacity-100 transition-opacity duration-300 hidden md:flex" // Navigationspfeil auf Mobilgeräten ausgeblendet
                onClick={onClick}
            >
                ›
            </div>
    ...
    const PrevArrow = ({ onClick }) => {
        return (
            <div
                className="absolute top-1/2 left-0 transform -translate-y-1/2 bg-dunkel text-white w-10 h-10 flex items-center justify-center rounded-full cursor-pointer z-10 opacity-30 hover:opacity-100 transition-opacity duration-300 hidden md:flex" // Navigationspfeil auf Mobilgeräten ausgeblendet
                onClick={onClick}
            >
                ‹
            </div>
